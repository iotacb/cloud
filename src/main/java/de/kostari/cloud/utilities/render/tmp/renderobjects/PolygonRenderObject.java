...
public class PolygonRenderObject extends RenderObject {

    private int amountOfSides;

    public PolygonRenderObject(float x, float y, float sideLength, float rotation, CColor color,
            int amountOfSides) {
        super(x, y, sideLength, 0, rotation, color, false);
